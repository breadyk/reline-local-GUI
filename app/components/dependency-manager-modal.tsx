...
export function DependencyManagerModal({ open, onClose }: {
    open: boolean
    onClose: () => void
}) {
        ...
        <ModalBase open={open} onClose={handleClose} className="w-full max-w-2xl max-h-[90vh] flex flex-col">
                ...
                {DEPENDENCIES.map((dep) => (
                    <div
                        ...
                        className={cn(
                            ...
                            installing === dep.id &&
                            "!animate-slow-pulse border-yellow-500", // Static yellow border
                            finishedDep === dep.id &&
            ...
            <div className="px-4 py-3 border-t border-border bg-zinc-100 dark:bg-zinc-800 flex justify-between">
                <div className="space-x-2">
                    ...
                    <Button
                        variant="outline"
                        onClick={() => window.electronAPI.checkDependencies()}
                        disabled={!!installing || installingAll || deleting}
                    >
                        Check dependencies
                    </Button>
